        ...
        <div className="flex-1 p-6 flex flex-col items-center justify-center bg-white min-h-0">
          ...
          {!imagePreview ? (
            <div 
              ...
              className="w-full h-full border-2 border-dashed border-gray-300 rounded-lg flex flex-col items-center justify-center cursor-pointer hover:border-indigo-500 hover:bg-gray-50 transition-all"
            >
